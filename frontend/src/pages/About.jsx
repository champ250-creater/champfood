      ...
      >
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-lg">
            Ntuma ni urubuga rwubatswe hagamijwe gufasha abatuye mubice bimwenabimwe byigihugu  kubona amafunguro meza kandi agezweho mu buryo bwihuse. Twizera ko guhahira ibiryo ku mbuga nkoranyambaga bikwiriye koroha, kwizerwa, kandi bikajyana n'ikoranabuhanga rigezweho.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-700 text-lg">
            Duhuza amahoteri n'amaresitora mubice bimwenabimwe byigihugu n'abakiriya babo. Ukoresheje Ntuma, ushobora guhitamo amafunguro ukunda, ukagaragaza aho uherereye ukoresheje GPS, maze tukakugezaho ibyo wategetse mu gihe gito cyane.
          </p>
        </section>
        ...
        <section className="mb-8 bg-orange-50 p-6 rounded-lg border-l-4 border-orange-600">
          ...
          <p className="text-orange-800">
            Ntuma yubatswe n'abahanga mu by'itumanaho n'ikoranabuhanga (champion group🏆), hagamijwe gukemura ibibazo by'itumanaho hagati y'umukiriya n'aho ibiryo bitunganyirizwa.
          </p>
        </section>
